export default function Navbar({scrollToDivId}) {
    ...
    return (
        <div className="sticky top-0 text-primary font-bold bg-[#fdffff] opacity-80 z-50 shadow-md flex justify-between px-5 py-1 items-center text-xs sm:text-base">
